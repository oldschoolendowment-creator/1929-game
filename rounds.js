...
const ROUNDS = {
  ...
  // Real historical monthly prices, 1920-1933, for the two reference
  ...
  // more of the real history as the game progresses. The 1920-1928
  // portion is included so round 1 already shows nine years of real
  // context before the game's own story begins in 1929, rather than
  // starting the player from a blank chart.
  //
  ...
  // this window, which is why it only has a handful of distinct values
  // across 168 months — that flatness is real, not a data gap.
  historicalPrices: {
